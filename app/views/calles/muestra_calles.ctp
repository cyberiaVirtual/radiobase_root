...
if($id_calle!="00")
{
    e($form->input('ServiciosProgramados.id_calle',array("id"=>"id_calle","label"=>false,"type"=>"select","options"=>$Calles,"empty"=>"-Calles-")));
...
}else
    {
        ...
        e($form->input('Calles.calle',array("label"=>false,"type"=>"text")));
    }
?>